...
// Source: simpleBank/tutorial (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 tutorial.AddAccountBalanceParams) (tutorial.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 tutorial.CreateAccountParams) (tutorial.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntries(arg0 context.Context, arg1 tutorial.CreateEntriesParams) (tutorial.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 tutorial.CreateTransferParams) (tutorial.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 tutorial.CreateUserParams) (tutorial.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (tutorial.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (tutorial.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (tutorial.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (tutorial.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUser(arg0 context.Context, arg1 string) (tutorial.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 tutorial.ListAccountsParams) ([]tutorial.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 tutorial.ListEntriesParams) ([]tutorial.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfer(arg0 context.Context, arg1 tutorial.ListTransferParams) ([]tutorial.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TotalBalance(arg0 context.Context) (float64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TotalBalance", arg0)
...
func (mr *MockStoreMockRecorder) TotalBalance(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TotalBalance", reflect.TypeOf((*MockStore)(nil).TotalBalance), arg0)
}

// TransferTx mocks base method.
func (m *MockStore) TransferTx(arg0 context.Context, arg1 tutorial.TransferTxParams) (tutorial.TransferTxResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 tutorial.UpdateAccountParams) (tutorial.Account, error) {
	m.ctrl.T.Helper()
